        ...
        <div className="backdrop-blur-sm md:rounded-full border-b border-white/20 md:border-1 relative">
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            <div className="h-20 flex items-center justify-between px-6">
              ...
              <div className="flex items-center space-x-4 ml-auto">
                ...
                <div className="md:hidden">
                  <Link 
                    href="/contact"
                    className={`bg-transparent text-white px-8 py-3 rounded-full text-sm tracking-widest uppercase transition-all ${activeSection === 'digital-solutions' ? 'border-[#806c00] hover:text-[#806c00]' : 'border-[#6B17ED] hover:text-[#6B17ED]'} border hover:bg-white hover:border-white`}
                  >
                    CONTACT
                  </Link>
                </div>
            ...
            <div className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row md:items-center md:justify-end md:flex-1 px-6 pb-4 md:pb-0 space-y-4 md:space-y-0 md:space-x-8 border-t border-white/10 md:border-0`}>
              <Link 
                href="/services" 
                className={`text-white transition-colors text-sm tracking-widest uppercase pt-4 md:pt-0 ${activeSection === 'digital-solutions' ? 'hover:text-[#806c00]' : 'hover:text-[#6B17ED]'}`}
              >
                SERVICES
              </Link>
              <Link 
                href="/blog" 
                className={`text-white transition-colors text-sm tracking-widest uppercase ${activeSection === 'digital-solutions' ? 'hover:text-[#806c00]' : 'hover:text-[#6B17ED]'}`}
              >
                BLOG
              </Link>
              <Link 
